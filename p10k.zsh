# Generated by Powerlevel10k configuration wizard on 2021-08-13 at 19:50 CEST.
...
() {
  ...
  function prompt_rysst_korall_reactnative() {
    [ -z "$REACTNATIVE_ENV" ] || p10k segment -f green -i '' -t 'rysst'
  }

  function instant_prompt_rysst_korall_reactnative() {
    prompt_rysst_korall_reactnative
  }
