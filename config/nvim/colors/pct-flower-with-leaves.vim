...
call s:hi("DiffAdd", { "fg": s:colors.green })
call s:hi("DiffChange", { "fg": s:colors.yellow })
call s:hi("DiffDelete", { "fg": s:colors.red })
call s:hi("DiffText", {})
call s:hi("EndOfBuffer", { "fg": s:colors.gray })
call s:hi("ErrorMsg", { "fg": s:colors.red })
call s:hi("VertSplit", { "fg": s:colors.darker.gray })
call s:hi("WinSeparator", { "fg": s:colors.darker.gray })
call s:hi("Folded", { "fg": s:colors.gray })
call s:hi("FoldColumn", { "bg": s:colors.black })
call s:hi("SignColumn", { "bg": s:colors.black })
call s:hi("IncSearch", { "fg": s:colors.black, "bg": s:colors.pink })
call s:hi("LineNr", { "fg": s:colors.darker.white, "bg": s:colors.black })
call s:hi("CursorLineNr", { "fg": s:colors.pink, "bg": s:colors.darker.gray })
call s:hi("CursorLineSign", { "fg": s:colors.pink, "bg": s:colors.darker.gray })
call s:hi("MatchParen", { "fg": s:colors.pink, "gui": "underline", "c": "underline" })
